...
class DataClient(BaseClient):
    ...
    def list_notification_endpoint_summaries(
        self,
        agent_id: int,
        organisation_id: int | None = None,
    ...
    def update_default_notification_subscription(
        self,
        agent_id: int,
        subscribed_to: int,
        severity: NotificationSeverity | int | None = None,
    ...
    def rotate_device_token(self, agent_id: int) -> RotatedDeviceToken:
    ...
    def confirm_device_token(self, agent_id: int) -> ConfirmedDeviceToken:
